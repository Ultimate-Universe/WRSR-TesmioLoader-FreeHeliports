#!/usr/bin/env python3
"""Finalize the FreeHeliports release DLL.
...
def make_version_info() -> bytes:
    ...
    strings = {
        ...
        "FileDescription": "FreeHeliports - TesmioLoader Plugin",
        "FileVersion": "1.0.0",
        "InternalName": "free_heliports",
        "OriginalFilename": "free_heliports.dll",
        "ProductName": "FreeHeliports",
...
def main() -> None:
    ...
    parser.add_argument("dll", nargs="?", default="free_heliports.dll")
