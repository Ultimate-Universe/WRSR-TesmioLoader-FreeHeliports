...
`finalize_pe.py` adds standard Windows `VERSIONINFO` metadata for v1.0.0 and writes the PE checksum. `verify_release.py` checks the architecture, TesmioLoader exports, hardening flags, native directories, section permissions and release markers.
